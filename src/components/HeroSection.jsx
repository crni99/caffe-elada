                            ...
                            <div className="hero-images">
                                ...
                                <div className="floating-images">
                                    <div className="floating-image floating-image-1">
                                        <img src="/assets/images/alfa-pivo-najbolji-grcki-mix.webp" alt={t('Hero.ImageAlt.floatingImage1')}
                                            className="img-fluid" width="123" height="123" />
                                    </div>
                                    <div className="floating-image floating-image-2">
                                        <img src="/assets/images/najstarije-grcko-pivo-mamos-elada.webp" alt={t('Hero.ImageAlt.floatingImage2')}
                                            className="img-fluid" width="123" height="123" />
                                    </div>
                                </div>
                            </div>
